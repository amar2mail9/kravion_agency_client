...
const Login = () => {
    return (
        <section className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-950 to-black flex flex-col items-center justify-center p-4 relative overflow-hidden text-gray-200">
            ...
            <section className="max-w-6xl w-full flex flex-col lg:flex-row items-center justify-center z-10 space-y-12 lg:space-y-0">
                ...
                >
                    ...
                    <p className="text-gray-400 text-lg max-w-sm leading-relaxed">
                        Log in to continue exploring cutting-edge tools and manage your productivity hub.
                    </p>

                    <section className="mt-16 text-md text-gray-400">
                        Don’t have an account?
                        <Link
                            href="/sign-up"
                            className="text-emerald-400 font-semibold hover:text-cyan-400 ml-1 transition-colors"
                        >
                            Sign up
                        </Link>
                    </section>
                ...
                >
                    ...
                    >
                        <section className="relative w-48 h-48 bg-gray-800/60 rounded-xl p-4 shadow-lg flex items-center justify-center border border-gray-700">
                            <section className="w-16 h-16 bg-gray-700 rounded-full relative flex items-center justify-center">
                                <section className="absolute bottom-0 right-0 w-6 h-6 bg-emerald-500 rounded-full flex items-center justify-center border-2 border-gray-800">
                                    <svg
